...
export default function AppClient({ household, userId, role, entries, recentEntries = entries, proposals, investments, valuations, members, ledgerSummary, postedEntryCount, initialTab = "总览", ledgerPage = 1, ledgerPageCount = 1, investmentSnapshots }: Props) {
...
export function Ledger({ entries, currency, members, totalEntries, page = 1, pageCount = 1 }: { entries: Row[]; currency: string; members: Row[]; totalEntries: number; page?: number; pageCount?: number }) {
  ...
  async function submit(event: React.FormEvent) {
    ...
    try {
      ...
      const payload = {
        ...
        currency: recordCurrency(type, household.reportingCurrency as Currency, selectedInvestment ? { currency: selectedInvestment.currency as Currency } : undefined),
