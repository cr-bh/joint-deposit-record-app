...
import { Dashboard, InvestmentList, Ledger, NewRecordButton, RecordModal } from "@/app/app/app-client";
...
export default function PreviewClient({ entries, investmentEntries, proposals, investments, valuations, members, accounts, accountBalances }: { entries: Row[]; investmentEntries: Row[]; proposals: Row[]; investments: Row[]; valuations: Row[]; members: Row[]; accounts: Row[]; accountBalances: AccountBalances }) {
